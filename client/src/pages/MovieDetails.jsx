...
const MovieDetails = () => {
    ...
    //State để quản lý việc mở/đóng trailer
    ...
    return show ? (
        <div className='relative px-6 md:px-16 lg:px-40 pt-30 md:pt-50 min-h-screen'>
                    ...
                    >
                        <div className='aspect-video'>
                            <iframe
                                width="100%"
                                height="100%"
                                src={`${show.movie.trailer_link}?autoplay=1`}
            ...
            <p className='text-lg font-medium mt-20 mb-8'>Bạn có thể thích</p>
            ...
            <div className='flex justify-center mt-20'>
                <button
                    ...
                    transition rounded-md font-medium cursor-pointer'>Xem thêm</button>
            </div>
