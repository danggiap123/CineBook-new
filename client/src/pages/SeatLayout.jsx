...
const SeatLayout = () => {
    ...
    const groupRows = [["A", "B"], ["C", "D"], ["E", "F"], ["G", "H"], ["I", "J"], ["K", "L"], ["M", "N"], ["O", "P"], ["Q", "R"]];
    ...
    return show ? (
        <div className='flex flex-col md:flex-row px-6 md:px-16 lg:px-40 py-30 md:pt-50'>
            ...
            h-max md:sticky md:top-30'>
                <p className='text-lg font-semibold px-6'>Thời gian chiếu phim</p>
            ...
            <div className='relative flex-1 flex flex-col items-center max-md:mt-16'>
                ...
                <p className='text-gray-400 text-sm mb-6'>MÀN HÌNH CHÍNH</p>
